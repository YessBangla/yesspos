...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Yess POS — Shop Billing, Stock & Reports" },
      { property: "og:description", content: "SheraPOS is a browser point-of-sale for retail shops: fast billing, automatic stock updates, daily sales reports. Bengali and English." },
      { name: "twitter:description", content: "SheraPOS is a browser point-of-sale for retail shops: fast billing, automatic stock updates, daily sales reports. Bengali and English." },
