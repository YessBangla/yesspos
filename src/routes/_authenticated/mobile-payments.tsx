...
export const Route = createFileRoute("/_authenticated/mobile-payments")({
  head: () => ({
    meta: [
      { title: "Mobile payments & reconciliation — Sokoler Bazar" },
      {
        name: "description",
      ...
      { property: "og:title", content: "Mobile payments & reconciliation — Sokoler Bazar" },
...
function MobilePaymentsPage() {
  ...
  const shopName = shop.data?.shop_name ?? "Sokoler Bazar";
