...
export const Route = createFileRoute("/_authenticated/sales")({
  head: () => ({
    meta: [
      { title: "Sales, quotations & returns — Sokoler Bazar" },
      {
        name: "description",
        content: "Search invoices, reprint receipts, collect dues, convert quotations and record sale returns.",
      },
      { property: "og:title", content: "Sales, quotations & returns — Sokoler Bazar" },
...
function SalesPage() {
  ...
  function printInvoice(sale: Sale, lines: Item[], size: PrinterSize) {
    ...
    printHtml(
      `<div class="center">
        <p class="shop">${escapeHtml(s?.shop_name ?? "Sokoler Bazar")}</p>
            ...
            <div className="space-y-3 text-sm">
              ...
              <ShareInvoiceButtons
                ...
                invoice={{
                  ...
                  shopName: settings.data?.shop_name ?? "Sokoler Bazar",
