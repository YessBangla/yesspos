...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Sokoler Bazar" },
      {
        name: "description",
        content:
          "The agreement governing use of the Sokoler Bazar platform: subscriptions, billing, acceptable use, data ownership, warranties and liability.",
      },
      { property: "og:title", content: "Terms of Service — Sokoler Bazar" },
      {
        property: "og:description",
        content: "Subscription terms, acceptable use, data ownership and liability for Sokoler Bazar customers.",
      },
...
function TermsPage() {
    ...
    ? [
        {
          ...
          body: [
            "Sokoler Bazar প্ল্যাটফর্মে অ্যাকাউন্ট খোলা বা ব্যবহারের মাধ্যমে আপনি (“গ্রাহক”) এই শর্তাবলিতে সম্মত হচ্ছেন। প্রতিষ্ঠানের পক্ষে সম্মত হলে আপনি নিশ্চিত করছেন যে আপনার সেই কর্তৃত্ব রয়েছে।",
          ],
        },
        {
          heading: "সেবার বিবরণ",
          body: [
            "Sokoler Bazar একটি সাবস্ক্রিপশনভিত্তিক ক্লাউড সফটওয়্যার যা বিলিং, ইনভেন্টরি, মাল্টি-ব্রাঞ্চ ব্যবস্থাপনা, হিসাব ও রিপোর্টিং সুবিধা দেয়। আমরা সময়ে সময়ে ফিচার যোগ, পরিবর্তন বা অপসারণ করতে পারি।",
          ],
        },
        {
    ...
    : [
        {
          ...
          body: [
            "By creating an account or otherwise using the Sokoler Bazar platform, you (“Customer”) enter into a binding agreement with us on these terms. If you accept on behalf of an organisation, you represent that you are authorised to bind that organisation.",
          ],
        },
        {
          heading: "Description of the service",
          body: [
            "Sokoler Bazar is a subscription-based cloud application providing billing, inventory, multi-branch operations, accounting and reporting functionality. We may add, modify or discontinue features, and will avoid materially degrading core functionality during a paid term.",
          ],
        },
        {
  ...
  return (
    <LegalPage
      ...
      intro={
        bn
          ? "এই শর্তাবলি Sokoler Bazar প্ল্যাটফর্ম ব্যবহারের নিয়ম, সাবস্ক্রিপশন, ডেটা মালিকানা ও দায়সীমা নির্ধারণ করে।"
          : "These terms govern access to and use of the Sokoler Bazar platform, including subscription commitments, acceptable use, data ownership and the allocation of risk between us."
      }
      sections={sections}
      footnote={
        bn
